...
export const groups = [
  {
    ...
    products: [
      { name: 'Obleas con todo', price: 5000 },
      { name: 'Obleas sin queso', price: 4000 },
      { name: 'Bolis', price: 3000 },
      { name: 'Combo con todo', price: 7000 },
    ],
    toppings: [],
    note: null,
    pendingConfig: [],
  ...
  },
  {
    ...
    toppings: [
      ...
      { name: 'Chispitas Chocolate', price: 1500 },
      { name: 'Chokis', price: 1500 },
      { name: 'MiniChips', price: 1500 },
      { name: 'Wafer', price: 1000 },
    ],
    note: null,
    pendingConfig: [],
  ...
  },
  {
    ...
    products: [
      { name: 'Platanos con proteina', price: 7500 },
  ...
  },
  {
    ...
    productoBase: 'Fresa',
    products: [
      { name: 'Fresas con crema', price: 5000 },
      { name: 'Pincho de fresa ', price: 4000 },
      { name: 'Pincho de fresa con malvadiscos', price: 4000 },
      { name: 'Adiciones', price: 1000 },
    ],
    toppings: [],
  ...
  },
  {
    ...
    products: [
      ...
      { name: 'Soda michelada de mango 16 onzas', price: 8000 },
      { name: 'Soda michelada de mango 12 onzas', price: 6500 },
      { name: 'Adición de pincho con gomitas y mango', price: 2000 },
      { name: 'Mango bañado con Chamoy, Tajín, gomitas', price: 5000 },
  ...
  },
  {
    ...
    productoBase: null,
    products: [
      { name: 'Arepas de chocolo con quesito', price: 4000 },
      { name: 'Empanadas', price: 1000 },
      { name: 'Palomitas', price: 2500 },
    ],
    toppings: [],
    note: null,
    pendingConfig: [],
